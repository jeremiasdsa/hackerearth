/**
 * Created by jeremias on 5/5/2017.
 */
/**
...
for (var i in inputs) {
    ...
    processData(inputs[i]);
    console.log(outputs[i], "<-ESPERAVA\n");
    //console.log("AssertEqual", inputs[i]===outputs[i]);
